...
package org.gearvrf.sutdvr.shaders;
...
public class ButtonShader {
    ...
    public static final String STATE4_BACKGROUND_TEXTURE = "state4Background";
    public static final String STATE4_TEXT_TEXTURE = "state4Text";
    ...
    public ButtonShader(GVRContext gvrContext) {
        ...
        mCustomShader.addTextureKey(STATE4_BACKGROUND_TEXTURE, STATE4_BACKGROUND_TEXTURE);
        mCustomShader.addTextureKey(STATE4_TEXT_TEXTURE, STATE4_TEXT_TEXTURE);
